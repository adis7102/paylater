...
export const statusPerkawinanInd = [
    {value : true, label : "Menikah"},
    {value : false, label : "Belum Menikah"}
]

export const penghasilanPertahunInd = [
    {value : "10 juta - 15 juta", label : "10 juta - 15 juta"},
    {value : "15 juta - 30 juta", label : "15 juta - 30 juta"},
    {value : "30 juta - 50 juta", label : "30 juta - 50 juta"},
    {value : "lebih dari 50 juta", label : "lebih dari 50 juta"}
]