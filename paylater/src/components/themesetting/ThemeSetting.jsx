        ...
        <ThemeSettingWrapper sidebarTheme={sidebarTheme}>
            ...
            >
                ...
                <Scrollbars style={{ height: "calc(100vh - 124px)" }} autoHide>
                    ...
                    <div className="alignment-radio">
                        ...
                        <div className="pretty p-default p-curve">
                            ...
                            <div className="state p-primary-o">
                                <label>
                                    {/* <IntlMessages  /> */}
                                    <p id="themeSetting.horizontal"></p>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div className="theme-setting-title">
                        {/* <IntlMessages  /> */}
                        <p id="themeSetting.themebuilder"></p>
                    </div>
                    <Switcher
                        themeType="gredient"
                    ...
                    <div className="theme-setting-title">
                        {/* <IntlMessages  /> */}
                        <p id="themeSetting.activepanel"></p>
                    </div>
...

                    {
                        ...
                        <Fragment>
                            <div className="theme-setting-title">
                                {/* <IntlMessages  /> */}
                                <p id="themeSetting.alignments"></p>
                            </div>

                            <div className="themeChangeBlock">
                                <h4>
                                    {/* <IntlMessages  /> */}
                                    <p id="themeSetting.topbar"></p>
                                </h4>
                            </div>
                            <div className="alignment-radio">
                                <div className="pretty p-default p-curve">
                            ...
                            <div className="theme-setting-title">
                                ...
                                <p id="themeSetting.display"></p>
                            </div>

                            <div className="themeChangeBlock">
                                <h4 id="themeSetting.topbar">
                                    {/* <IntlMessages  /> */}
                    ...
                    <div className="theme-setting-title">
                        ...
                        <p id="themeSetting.sidebarmini"></p>
                    </div>
                    ...
                    <div className="theme-setting-title">
                        ...
                        <p id="themeSetting.sidebartransparent"></p>
                    </div>

                    <div className="themeChangeBlock">
                        <h4>
                            {/* <IntlMessages id="themeSetting.tranperentmod" /> */}
                            <p id="themeSetting.tranperentmod"></p>
                        </h4>
                    </div>
                    <div className="alignment-radio">
                        <div className="pretty p-default p-curve">
