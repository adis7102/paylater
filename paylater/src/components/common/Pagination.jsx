...
const Pagination = props => {
    ...
    useEffect(() => {
        setvisiblePages(getVisiblePages(null, getTotalPages() ));
    }, [getVisiblePages, getTotalPages() ]);
    ...
    const changePage = page => {
        ...
        const visiblePages = getVisiblePages(page, getTotalPages() );

        setvisiblePages(filterPages(visiblePages, getTotalPages() ));
